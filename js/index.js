        ...
        dr.forEach(function(dc, j) {
            if (!excludeColIdxArr.includes(j)) {
                ...
                if (lkpColIdxArr.includes(j)) {
                    ...
                    $("[id='" + tdId + "']").append("<select id='sel_" + tdId + "' style='width:" + (colW + 1) + "em; font-size:80%;' class='form-select form-select-sm' data-lookupname='" + colLkpListName + "'></select>");
                ...
                if (colDataType == "string") {
                    ...
                    $("[id='" + tdId + "']").append("<input type='text' style='width:" + colW + "em; font-size:80%;' class='form-control form-control-sm' value='" + dc.value + "'>");
                ...
                if (colDataType == "integer" || colDataType == "int") {
                    $("[id='" + tdId + "']").append("<input type='number' style='width:" + colW + "em; font-size:80%;' class='form-control form-control-sm' value='" + dc.value + "'>");
                ...
                // datype = date
                if (colDataType == "date") {
                    $("[id='" + tdId + "']").append("<input type='text' style='width:7em; font-size:80%;' class='form-control form-control-sm' value='" + dc.value + "'>");
                    var dtOptions = {
                        format: 'yyyy-mm-dd',
                        todayHighlight: true,
                        autoclose: true,
